...
public class RegistroFila {
	...
	public static void main(String[] args) 
	{
	    ...
	    Queue<String> ClientesNaFila = new LinkedList<String>();
	...
	private static void processarEscolha(int Escolha, Queue<String> ClientesNaFila, Scanner read) 
	{ 
		switch(Escolha) 
		{
			case 1:
			...
			case 3:
				System.out.println("============================================================");
				System.out.println(" Digite o nome completo do cliente que deseja retirar da fila");
				System.out.println("============================================================");
				System.out.print(" Nome Completo:");
				String NomeRemovido = read.next().toLowerCase();
				boolean ClienteEncontrado = false;
					if (ClientesNaFila.contains(NomeRemovido)) 
					{
						ClientesNaFila.remove(NomeRemovido);
						ClienteEncontrado = true;
					}
					if (!ClienteEncontrado) 
					{
						System.out.println("=================================================");
						System.out.println("O cliente inserido não existe");
						System.out.println("=================================================");
					}
			 break;
